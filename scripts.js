...
/* === Envoi de PDF par e-mail === */
const { jsPDF } = window.jspdf;

document.getElementById('send-email').addEventListener('click', function () {
  console.log("Bouton 'Envoyer par e-mail' cliqué");

  var tooltipContent = document.getElementById('tooltip-content');

  var doc = new jsPDF();
  doc.html(tooltipContent, {
    callback: function (doc) {
      var email = prompt("Entrez votre adresse e-mail pour recevoir le PDF :");
      if (!email) {
        alert("Adresse e-mail non fournie. Annulation.");
        return;
      }
      ...
      formData.append('pdf', pdfData, 'tooltip.pdf');
